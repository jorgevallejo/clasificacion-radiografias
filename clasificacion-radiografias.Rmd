...
Una vez calculadas las curvas ROC y los valores de AUC, podemos ver que el mayor AUC (###valorAUCmáximo###) corresponde al valor de k (###índicedelvalorAUCmáximo###).

El valor k para el mínimo de falsos positivos corresponde a ###

El valor k para el mínimo de falsos negativos corresponde a ###

El valor k para el error total mínimo es ###

Dado que el error potencialmente más perjudicial para el paciente son los falsos negativos, deberíamos elegir el valor de k ###. Este resulta en un falso negativo del ###, falso positivo del ### y AUC de ###.
